...
const INITIAL_ANNOUNCEMENTS = [
  { id: "ann-1", type: "announcement", title: "Mid-Term 2 Hall Allocation Published", body: "Hall assignments for Mid 2 exams (Week 10) are now available on the LMS portal under 'Exam Schedule'. Students must carry their university ID cards.", from: "Exam Office", audience: "All Students", date: "Mar 18, 2025", pinned: true },
  { id: "ann-2", type: "announcement", title: "LMS Maintenance — Saturday 2–4 AM", body: "The LMS portal will be unavailable for scheduled maintenance this Saturday between 2:00 AM and 4:00 AM. Please plan all assignment submissions accordingly.", from: "IT Department", audience: "All Students", date: "Mar 16, 2025", pinned: true },
  { id: "ann-3", type: "exam", title: "OOAD Assignment 2 — Groups of 3 Only", body: "Reminder: Individual submissions for OOAD Assignment 2 will not be accepted. All groups must be registered on LMS before the submission date.", from: "Dr. Hamza Raheel", audience: "BS-CS", date: "Mar 14, 2025", pinned: false },
];
...
function AnnCard({ ann, onEdit, onDelete, onTogglePin }) {
  ...
  return (
    <motion.div layout initial={{ opacity: 0, y: 16 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, scale: .95 }} transition={{ duration: .28 }} className="adm-card ann-card-hover" style={{ padding: 0, overflow: "hidden", marginBottom: 24, borderRadius: 24 }}>
      <div style={{ height: 6, background: meta.color, borderRadius: "24px 24px 0 0" }} />
